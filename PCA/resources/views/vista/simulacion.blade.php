...
<div class="fondo">
    <table>
      <tr>
        <th colspan="3">Trámites de la Via Ordinaria </th>
      </tr>
      <tr>
        <td><div class="fat-finger color2 smallipop" id="proceso4">Presentación de Pruebas
            <div class="dot-4"></div>
                <!-- <div class="smallipop-hint">
              <img src="images/animated-judge-image-0041-tiny.gif" alt="Flying screens"
                 style="float:left; margin:0 15px 20px 0" />
              ...
              <table style="margin:0">
                <tr>
                  <td class="label">Decreto <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Traslado  <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Acumulación   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Igualación de procesos   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Sentencia   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
              </table>
        ...
        <td></td>
        <td><div class="fat-finger color2 smallipop" id="proceso5">Aprobación de los Trámites
            <div class="dot-5"></div>
            <!-- <div class="smallipop-hint">
              <img src="images/animated-judge-image-0041-tiny.gif" alt="Flying screens"
                 style="float:left; margin:0 15px 20px 0" />
              ...
              <table style="margin:0">
                <tr>
                  <td class="label">Obligación de excusa <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Excusa observada  <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Excusa declarada ilegal   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
              </table>
      ...
      <tr>
        <td></td>
        <td><div class="fat-finger color2 smallipop" id="proceso6">Utilización de Recursos Disponibles
            <div class="dot-6"></div>
            <!-- <div class="smallipop-hint">
              <img src="images/animated-judge-image-0041-tiny.gif" alt="Flying screens"
                 style="float:left; margin:0 15px 20px 0" />
...
<div class="fondo">
    <table>
      ...
      <tr>
        <td><div class="fat-finger color3 smallipop" id="proceso7">Alegación por ambas partes
            <div class="dot-7"></div>
            <!-- <div class="smallipop-hint">
              <img src="images/animated-judge-image-0041-tiny.gif" alt="Flying screens"
                 style="float:left; margin:0 15px 20px 0" />
              ...
              <table style="margin:0">
                <tr>
                  <td class="label">Admisión de la demanda <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Demanda con pretensión múltiple  <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Ampliación y modificación de la demanda   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
                <tr>
                  <td class="label">Retiro de la demanda   <span class="fa fa-check"></span></td>
                  <td class="value"></td>
                </tr>
              </table>
              <a href="release-notes">   FIN</a>
        ...
        <td></td>
        <td><div class="fat-finger color3">Juez dicta Resolución
            <div class="dot-8"></div>
        </div></td>
      </tr>
      <tr>
        <td></td>
        <td><div class="fat-finger color3">Utilización de Recursos Disponibles
            <div class="dot-9"></div>
        </div></td>
        <td></td>
      </tr>
...
<div class="fondo2">
    <table>
      ...
      <tr>
        <td>
        <div class="fat-finger color4">Recursos Judiciales de Apelación
      ...
      <tr>
        <td>
        <div class="fat-finger color4">Recursos Judiciales de Casación
      ...
      <tr>
        <td>
        <div class="fat-finger color4">Recursos Judiciales de Queja
